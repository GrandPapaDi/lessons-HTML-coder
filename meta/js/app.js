(() => {
    ...
    window.onload = () => {
        ...
        document.querySelectorAll(".activity__video-block").forEach((videoBlock => {
            observer.observe(videoBlock);
        }));
        document.addEventListener("click", (function(e) {
            const parentEl = e.target.closest(".activity__video-block");
            if (parentEl) {
    ...
    window.onload = () => {
        ...
        document.querySelectorAll(".activity__video-block").forEach((videoBlock => {
            ...
            videoBlock.addEventListener("mouseenter", (function() {
                ...
                const playButton = videoBlock.querySelector(".activity__play-button");
        ...
        document.addEventListener("click", (function(e) {
            ...
            if (parentEl) {
                const video = parentEl.querySelector("video");
                toggleVideo(video, parentEl);
                const playButton = parentEl.querySelector(".activity__play-button");
                playButton.style.opacity = "0";
            }
        }));
    };
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const slides = document.querySelectorAll(".activityslide");
        slides.forEach((slide => {
            const video = slide.querySelector(".activityvideo");
            const playButton = slide.querySelector(".activityplay-button");
            const videoContainer = slide.querySelector(".activityvideo-container");
