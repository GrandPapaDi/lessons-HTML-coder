(() => {
    ...
    const play = document.querySelector(".collect__icon");
    const circle = document.querySelector(".collect__circle");
    play.addEventListener("mouseenter", (() => {
        circle.classList.add("rotate-reverse");
    }));
    play.addEventListener("mouseleave", (() => {
        circle.classList.remove("rotate-reverse");
    }));
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".swiper", {
            ...
            navigation: {
                prevEl: ".collect__button-prev",
                nextEl: ".collect__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
